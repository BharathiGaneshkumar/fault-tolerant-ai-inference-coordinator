...
const file_proto_raft_proto_rawDesc = "" +
	...
	"\rlast_log_term\x18\x04 \x01(\x05R\vlastLogTerm\"g\n" +
	"\x13RequestVoteResponse\x12\x19\n" +
	"\bvoter_id\x18\x01 \x01(\x05R\avoterId\x12\x12\n" +
	"\x04term\x18\x02 \x01(\x05R\x04term\x12!\n" +
	"\fvote_granted\x18\x03 \x01(\bR\vvoteGranted\"8\n" +
	"\bLogEntry\x12\x12\n" +
	"\x04term\x18\x01 \x01(\x05R\x04term\x12\x18\n" +
	"\acommand\x18\x02 \x01(\tR\acommand\"\xe0\x01\n" +
	"\x14AppendEntriesRequest\x12\x1b\n" +
	"\tleader_id\x18\x01 \x01(\x05R\bleaderId\x12\x12\n" +
	"\x04term\x18\x02 \x01(\x05R\x04term\x12$\n" +
